...
class TronAdapter(BlockchainAdapter):
    ...
    async def get_all_token_transfers(
        ...
        for page in range(1, max_pages + 1):
            ...
            for tx in raw_page:
                ...
                # Compound key for deduplication across pages
    ...
    def normalize_transaction(self, raw_tx: Dict[str, Any]) -> NormalizedTransactionBase:
        ...
        # Asset symbol & contract determination
        ...
        # Amount conversion using Decimal for financial precision
        ...
        # Block number (None if not present in TRC20 event payload)
    ...
    def persist_transactions(
        ...
        for tx in transactions:
            # Deterministic unique ID preventing duplicates while handling multi-logs per tx
